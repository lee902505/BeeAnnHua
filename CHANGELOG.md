## V0.9.72c - Mobile Combat Area + Shop Scroll Fix
- 手機直式可行走範圍改為接近實測紅框，左右/上下安全邊界重新校正。
- Position Engine 手機邊界改參考左上角色卡、金幣列、右上按鈕與底部戰鬥紀錄/快捷欄。
- 修正手機商店購買窗內層滾動回彈，商品清單/說明/購買按鈕可正常操作。
- 金幣列可點擊顯示完整 Zeny / 藍寶石 / 紅寶石數量，避免窄螢幕省略造成看不到。
- 版本號更新為 0.9.72c。
