# Stellar Diary Backend Foundation — V0.10.7.2.1
...
The backend is intentionally disabled by default in V0.10.7.2.1. Before loading `backend-config.js`, a deployment can provide a public runtime object:
