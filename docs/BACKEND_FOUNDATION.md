# Stellar Diary Backend Foundation — V0.10.7.2.2
...
The backend is intentionally disabled by default in V0.10.7.2.2. Before loading `backend-config.js`, a deployment can provide a public runtime object:
