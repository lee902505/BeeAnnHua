...
// dropMultiplier：整體隨機掉寶倍率（一般／特殊／卡片／隨機試煉掉落）
...
function getExpGainMult(lv) { return lv >= 100 ? 0 : getGlobalExpMultiplier(); }   // ⚠️v2.6.40 取消高等經驗遞減（恆全額）；滿等(100)仍不獲得。遞減效果改由 getExpReq 提高需求承擔。
