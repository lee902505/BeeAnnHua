(() => {
  ...
  const T = {
    'zh-CN': {
      brand:'星辰日记', home:'返回首页', eyebrow:'V0.10.7.11 · ACCOUNT LOGIN & OTP',
    ...
    'zh-TW': {
      brand:'星辰日記', home:'返回首頁', eyebrow:'V0.10.7.11 · ACCOUNT LOGIN & OTP',
