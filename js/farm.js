(() => {
  ...
  // V0.13.17 — ROWEB-style crop atlas metadata. The source stays as one
  ...
  const CROP_ATLAS = Object.freeze({
    ...
    crops:Object.freeze({
      carrot:Object.freeze({row:0, scale:1.00, lift:-4}),
      wheat:Object.freeze({row:1, scale:.96, lift:-5}),
      corn:Object.freeze({row:2, scale:.90, lift:-4}),
      tomato:Object.freeze({row:3, scale:.94, lift:-4})
    })
  });
